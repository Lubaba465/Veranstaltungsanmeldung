<form class="default" action="<?= $controller->url_for('wizard/process', $stepnumber, $temp_id) ?>" method="post">
<fieldset>
        ...
        <label>
            ...
            <?= sprintf(
                ...
                sprintf(
                    ...
                    URLHelper::getLink('dispatch.php/details', ['sem_id' => $source_course->id]),
