...
if ($input['type'] === "checkbox") : ?>
    <input <?=$is_locked ?> type="checkbox" name="<?= $input['name'] ?>" value="<?= htmlReady($input['value']) ?>" <?= htmlReady($input['checked']) ? " checked" : "" ?> <? if ($input['must']) echo 'required'; ?>>
<? endif;
