...
require_once 'lib/classes/StudipLvgruppeSelection.class.php';

class LVGroupsWizarStep implements CourseWizardStep
{
    /**
    ...
    public function getStepTemplate($values, $stepnumber, $temp_id)
    {
        ...
        $factory = new Flexi_TemplateFactory($GLOBALS['PLUGINS_PATH'] . '/Lubaba/Veranstaltungsanmeldung/views/wizard_a/steps');
    ...
    public function validate($values)
    {
        ...
        if ($category->bereiche) {
            if ( !count($values['StudyAreasLVGroupsCombinedWizardStep']['studyareas'])
